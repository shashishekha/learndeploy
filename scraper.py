...
DRIVER_PATH = r'C:\Users\HP\Desktop\ImageScrapper\ImageScrapper\chromedriver1.exe'
search_term = 'tourist place'
# num of images you can pass it from here  by default it's 10 if you are not passing
#number_images = 50
search_and_download(search_term=search_term, driver_path=DRIVER_PATH, number_images=150)

#Try to store all of these images in mongo_db
#Try to implement it with class and object
#coding standard
#write a function for fetch all the image based on their name from database.
